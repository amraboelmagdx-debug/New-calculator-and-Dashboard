...
/** @alias useQuoteWorkflow — pricing command center workflow */
export function useQuoteCalculator(ctx) {
  return useQuoteWorkflow(ctx);
}

export { DEAL_STEPS, computeQuoteReadiness, getStepCompletion };
